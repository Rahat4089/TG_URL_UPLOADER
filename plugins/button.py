...
async def youtube_dl_call_back(bot, update):
    ...
    if "mediafire.com" in youtube_dl_url:
        mediafire_direct_link = get_mediafire_direct_link(youtube_dl_url)
        if mediafire_direct_link:
            youtube_dl_url = mediafire_direct_link  # Use the direct download link for further processing
        else:
    ...
    if any(
        ...
        terabox_direct_link = get_terabox_direct_link(youtube_dl_url)
        if terabox_direct_link:
            youtube_dl_url = terabox_direct_link  # Use the direct download link for further processing
        else:
